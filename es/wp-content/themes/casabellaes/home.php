  ...
  <div class="container">
    ...
    <div class="row">
      <div class="small-12 columns center show-for-small-only">
        <button href="#" data-dropdown="drop1" aria-controls="drop1" aria-expanded="false" class="button dropdown">Choose a location in Lima</button><br>
        <ul id="drop1" data-dropdown-content class="f-dropdown" aria-hidden="true">
          <li class="">
                  ...
                  <li class="">
                    <a href="http://www.casabellaperu.net/grand-reserve/">Casa Bella Grand Reserve Miraflores</a>
                  </li>
                  <li class="">
                    <a href="http://www.casabellaperu.net/apartments-suites/" title="Apartments and suites">Casa Bella Apartments &amp; Suites</a>
                  </li>
                  <li class="">
                    <a href="http://www.nathanoscafe.com/" target="_blank">Nathano's Café</a>
                  </li>
        </ul>
      </div>
      <div class="small-12 columns center hide-for-small-only">

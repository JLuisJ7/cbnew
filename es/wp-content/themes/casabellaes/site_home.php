...
<div class="container bg-datos">
  ...
  <div class="small-12 columns datos">
    <p style="display:inline-block!important;">
        <span class="hide-for-small" >Hoteles Boutique en Lima Perú - Av. De La Aviación 565 Miraflores Lima - Perú Phone: (511) 421-7354 - (511) 421-1033 - In USA: (720) 648-3451</span>
	...
	<div class="small-12 medium-6 large-4 columns margin-b">
		<div class="botones">
			<a href="<?php echo get_option('home'); ?>/airport-transfer-services/" title="<?php echo get_option('subbox1desc'); ?>">
				<img src="<?php bloginfo('template_directory'); ?>/images/buttons/aeropuerto.png" alt="" class="btn_image">
			</a>
		</div>
	</div>
	<div class="small-12 medium-6 large-4 columns margin-b">
		...
		<div class="botones">
			<a href="<?php echo get_option('home'); ?>/rates-availability/" title="<?php echo get_option('subbox2desc'); ?>">
				<img src="<?php bloginfo('template_directory'); ?>/images/buttons/precios.png" alt="" class="btn_image">
			</a>
		</div>
	...
	<div class="small-12 medium-12  large-4 columns margin-b">
		...
		<div class="botones">
			<a href="https://secure.guestcentric.net/api/bg/book.php?apikey=f574d237ca9871f55c306a1903e7c50a" title="<?php echo get_option('subbox3desc'); ?>">
				<img src="<?php bloginfo('template_directory'); ?>/images/buttons/reserva.png" alt="" class="btn_image"> 
			</a>
		</div>
...
<div class="row site_home_content">
	<div class="small-12  medium-12 large-4 columns">
		...
		?>
		<p>
			<a href="<?php echo get_option('home'); ?>/about-us/">Leer Mas &rarr;</a>
		</p>
		<div style="text-align:left; font-size:14px; color:#000; margin-bottom:20px;">
			<p>Hora Local: <span class="jclock"></span></p>
		</div>
	...
	<div class="small-12  medium-6 large-4 columns">
		...
		<h5 class="tit_home"><a href="<?php echo get_option('home'); ?>/?cat=10"><?php the_title(); ?></a></h5>

		<?php

		$more = 0;

		the_content("Leer Mas &rarr;");

		endwhile; 

		?>
		<p><a href="<?php echo get_option('home'); ?>/?cat=10">Ver todas las habitaciones &rarr;</a></p>
		<?php query_posts('showposts=1&page_id=764');
		while (have_posts()) : the_post(); ?>
		...
		<h5 class="tit_home"><a href="<?php echo get_option('home'); ?>/category/blog/">Noticias &amp; Blog</a></h5>
	...
	<div class="small-12  medium-6 large-4 columns">
		<div id="blog_home">
			<?php query_posts('showposts=1&page_id=767');
				while (have_posts()) : the_post(); ?>
				<h5 class="tit_home"><a href="<?php echo get_option('home'); ?>/contacto/"><?php the_title(); ?></a></h5>
				<?php
			...
			<?php query_posts('showposts=1&page_id=770');
			while (have_posts()) : the_post(); ?>

			<h5 class="tit_home"><a href="http://www.casabellaperu.net/gallery/"><?php the_title(); ?></h5>

...
<p class="textosup">Hotels in Lima Peru - Av. De La Aviación 565 Miraflores Lima - Per&uacute; Phone: (511) 421-7354 - (511) 421-1033 - In USA: (720) 648-3451 <span class="flags"><a href="<?php echo get_option('home'); ?>/es/"><img src="<?php bloginfo('template_directory'); ?>/images/icons/spanish.gif" width="16" height="11" alt="spanish" /></a> <a href="<?php echo get_option('home'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/icons/english.gif" width="16" height="11" alt="english" /></a> <a href="http://www.peru.o-kom.info/casabellaperu/" target="_self"><img src="<?php bloginfo('template_directory'); ?>/images/icons/german.gif" width="16" height="11" alt="german" /></a></span></p></div>
